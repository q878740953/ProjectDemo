            ...
            <section class="content">
                ...
                <table id="dataList"
                    ...
                    <c:forEach items="${roleList}" var="role" varStatus="status">
                        <tr>
                        <td>
                            <input id="c${role.id}" name="ids" type="checkbox" value="${role.id}">
                        </td>
                        <td>${role.id}</td>
                        <td>${role.roleName }</td>
                        <td>${role.roleDesc}</td>
...
<script type="application/javascript">
    <c:forEach items="${roleList}" var="role">
        <c:forEach items="${existRoleList}" var="existRole">
            if (${role.id == existRole.id}){
                document.getElementById("c${role.id}").setAttribute("checked", "checked");
            }
        </c:forEach>
    </c:forEach>
</script>
